...
const SingleTenancyPage = React.lazy(() => catchChunkError(() => import('../components/pages/single-tenancy-page')))
      ...
      <Switch>
        ...
        <PrivateRouteWrapper>
          <Switch>
            ...
            <Route path={Routes.SINGLE_TENANCY} exact component={SingleTenancyPage} />
          </Switch>
        </PrivateRouteWrapper>
